...
5. Run a production build and one smoke test of the main route or user flow.
6. Keep `.github/workflows/repo-health.yml` if you want docs and setup checks in pull requests.
